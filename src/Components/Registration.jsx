...
const Registration = () => {
  ...
  const validate = () => {
    ...
    if (!Registerdata.mobile_number) errors.mobile_number = "Mobile number is required";
            ...
            <div className="mb-4 relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`border ${formErrors.name ? 'border-red-500' : 'border-gray-300'} rounded-md px-3 py-2 pl-10 w-full`}
                />
              </div>
            ...
            <div className="mb-4 relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`border ${formErrors.mobile_number ? 'border-red-500' : 'border-gray-300'} rounded-md px-3 py-2 pl-10 w-full`}
                />
              </div>
                {formErrors.mobile_nuxmber && <p className="text-red-500 text-sm mt-1">{formErrors.mobile_number}</p>}
            </div>
