            ...
            <div className="mb-4 relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`border ${formErrors.mobile_number
                      ? "border-red-500"
                      : "border-gray-300"
                    } rounded-md px-3 py-2 pl-10 w-full`}
                />
            ...
            <div className="mb-4 relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`border ${formErrors.password ? "border-red-500" : "border-gray-300"
                    } rounded-md px-3 py-2 pl-10 w-full`}
                />
                <button
                  type="button"
            ...
            <div className="mb-4 relative">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`border ${formErrors.confirmPassword
                      ? "border-red-500"
                      : "border-gray-300"
                    } rounded-md px-3 py-2 pl-10 w-full`}
                />
