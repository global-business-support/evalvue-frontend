            ...
            <table className="w-full border-separate border-spacing-y-3">
              <thead>
                <tr>
                  ...
                  <td className="text-left font-bold text-black  py-2 sm:px-4 px-1 sm:text-base text-[12px]">Document Number:</td>
                  <td className="text-left font-bold text-black  py-2 sm:px-4 px-1 sm:text-base text-[12px]">Address:</td>
                  <td className="text-left font-bold text-black  py-2 sm:px-4 px-1 sm:text-base text-[12px]">View:</td>
              ...
              <tbody>
                {Orgdata.map((organization, index) => (
                  ...
                  >
                      <td className={`py-3 sm:px-4 px-1 w-[25%] bg-${organization.organization_verified ? "white" : "[#f3f7fc]"} rounded-l-lg border-l  shadow-top-bottom-xl`}>
