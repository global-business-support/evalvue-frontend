      ...
      {!success ? (
        <div className="shadow-md rounded-lg p-6 bg-zinc-200 max-w-md w-full mb-8">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="new-password" className="block text-zinc-800 mb-2">New Password</label>
              <input
                type="password"
                id="new-password"
        ...
        <div className="shadow-md rounded-lg p-6 max-w-md w-full bg-zinc-200">
          ...
          <p className="text-center text-zinc-600 dark:text-zinc-400 mb-6">You can now use your new password to login to your account 🎉</p>
          <NavLink to='/login'>
